...
TwitterPad is an automatic RSS-to-page plugin designed to integrate with [twitter](http://twitter.com). This plugin allows the user to add a number of custom search strings from [search.twitter.com](http://search.twitter.com) specifying which page new tweets should be added to. 
